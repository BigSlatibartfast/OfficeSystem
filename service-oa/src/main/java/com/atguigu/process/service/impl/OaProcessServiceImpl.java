...
public class OaProcessServiceImpl extends ServiceImpl<OaProcessMapper, Process> implements OaProcessService {
    ...
    public IPage<ProcessVo> findPending(Page<Process> pageParam) {
        ...
        for (Task task : taskList) {
            ...
            System.out.println("============businessKey等于:" + businessKey);
            System.out.println("============processId：" + processId);
            Process process = baseMapper.selectById(processId);
            System.out.println("============process内容：" + process.toString());
    ...
    public IPage<ProcessVo> findProcessed(Page<Process> pageParam) {
        ...
        for (HistoricTaskInstance item : list) {
            ...
            System.out.println("============processInstanceId流程实例id："+processInstanceId);
            wrapper.eq(Process::getProcessInstanceId,processInstanceId);
            Process process = baseMapper.selectOne(wrapper);
            System.out.println("============process流程:"+process.toString());

            //把process对象转成ProcessVo
            ProcessVo processVo = new ProcessVo();
            BeanUtils.copyProperties(process,processVo);
            //放到list
            processVoList.add(processVo);
